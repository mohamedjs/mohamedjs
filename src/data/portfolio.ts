...
export const projects: Project[] = [
  {
    ...
    cover: `${BASE}projects/tripklik/tripklik-cover.png`,
    gallery: [
      `${BASE}projects/tripklik/tripklik-2.png`,
      `${BASE}projects/tripklik/tripklik-3.png`,
    ],
  ...
  },
  {
    ...
    cover: `${BASE}projects/7alm/7alm-4.png`,
    gallery: [
      `${BASE}projects/7alm/7alm-cover.png`,
      `${BASE}projects/7alm/7alm-2.png`,
      `${BASE}projects/7alm/7alm-3.png`,
      `${BASE}projects/7alm/7alm-5.png`,
      `${BASE}projects/7alm/7alm-6.png`,
      `${BASE}projects/7alm/7alm-7.png`,
      `${BASE}projects/7alm/7alm-8.png`,
    ],
  ...
  },
  {
    ...
    cover: `${BASE}projects/automation/automation-cover.png`,
    gallery: [
      `${BASE}projects/automation/automation-whatsapp.png`,
      `${BASE}projects/automation/automation-telegram.png`,
      `${BASE}projects/automation/automation-calendar.png`,
      `${BASE}projects/automation/automation-notion.png`,
    ],
    accent: "#ff6d5a",
  },
  {
    ...
    cover: `${BASE}projects/ratatouille/ratatouille-cover.png`,
    gallery: [
      `${BASE}projects/ratatouille/ratatouille-2.png`,
      `${BASE}projects/ratatouille/ratatouille-3.png`,
    ],
  ...
  },
  {
    ...
    cover: `${BASE}projects/kidnap/kidnap-cover.png`,
    gallery: [
      `${BASE}projects/kidnap/kidnap-2.png`,
      `${BASE}projects/kidnap/kidnap-3.png`,
    ],
